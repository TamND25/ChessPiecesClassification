...
# Load trained model
model = load_model("chess_classification_model.h5")

# Output file for saving predictions
output_file = "predictions_origin_crop.txt"
...
def predict_class(img_class, save_dir="predictions_origin_model_crop_images"):
    """Predict the class for all images in a given folder and save results."""
    TEST_DIR = Path(f'clean_cropped_dataset/test/{img_class}')
